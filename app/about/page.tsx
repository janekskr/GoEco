    ...
    <div className="px-[15vw] py-[40px] sm:py-[60px] text-xl">
      ...
      <p className="leading-8 text-center sm:text-left">
        GoEco to projekt zrobiony na konkurs <a href="https://nowaakademia.org/mini-hackathon/mini-hackathon-edycja-iii/" target="_blank" className="text-white font-bold relative">
          Mini Hackaton
          <svg className="w-full left-0 absolute stroke-[#02674e] top-[4px]" width="244" height="40" viewBox="0 0 244 40" fill="none">
            <path opacity="0.5" d="M3 21C20.1231 17.8525 37.9303 16.8192 55.3857 16.0719C84.6481 14.819 114.132 14.5194 143.388 15.9599C169.598 17.2503 195.455 20.3554 221.642 17.7519C228.347 17.0853 237.394 16.9679 244 16.9679" strokeWidth="16" strokeLinejoin="round" />
          </svg>
          ...
          {/* <CustomSvg Top="4px" /> */}
            <svg className={`w-full left-0 absolute stroke-[#02674e] top-[4px]`} width="244" height="40" viewBox="0 0 244 40" fill="none">
            <path opacity="0.5" d="M3 21C20.1231 17.8525 37.9303 16.8192 55.3857 16.0719C84.6481 14.819 114.132 14.5194 143.388 15.9599C169.598 17.2503 195.455 20.3554 221.642 17.7519C228.347 17.0853 237.394 16.9679 244 16.9679" strokeWidth="30" strokeLinejoin="round" />
          </svg>
          </a>.
      </p>
